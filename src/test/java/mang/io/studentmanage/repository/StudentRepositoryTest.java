...
//    }
    ...
    public void printgetStudentByEmailAddress(){
        Student student =
                studentRepository.getStudentByEmailAddress("mangio@gmail.com");
        System.out.println("Student emails = " + student);
    }

    @Test
    public void getStudentNameByEmailId(){
        String student = studentRepository.getStudentNameByEmailAddress("mangio@gmail.com");
        System.out.println("Student name" + student);
    }

    @Test
    public void getStudentIdNative(){
        Student student = studentRepository.getStudenByEmailIdNative("mangio@gmail.com");
        System.out.println("Student name: " + student);
    }

    @Test
    public void getName(){
        Student student  = studentRepository.getStudentNameParams("mangio@gmail.com");
        System.out.println("student: " + student);
    }
    @Test
